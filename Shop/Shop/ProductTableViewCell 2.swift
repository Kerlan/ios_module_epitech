...
class ProductTableViewCell: UITableViewCell {
    ...
    func apply(product: Product) {
        ...
        priceLabel.text = product.priceCents.currencyFormatted // TODO: Update with product price.currencyFormatted

        productImageView.image = UIImage.init(named: product.image) // TODO: Update with product image name
        setNeedsLayout()
    }
